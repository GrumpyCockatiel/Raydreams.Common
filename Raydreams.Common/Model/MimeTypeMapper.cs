...
namespace Raydreams.Common.Model
{
    ...
    public static class MimeTypeMap
    {
        ...
        /// <param name="extension">file extension optionally preceeded with a .</param>
        /// <returns></returns>
        public static string GetMimeType( string extension )
        {
            ...
            // return a default if no extension
        ...
        public static string GetExtension( string mimeType )
        {
            ...
            if ( mimeType.StartsWith( "." ) )
                throw new System.ArgumentException( $"Requested mime type is not valid: {mimeType}" );

            if ( _mappings.Value.TryGetValue( mimeType, out string extension ) )
                return extension;

            throw new System.ArgumentException( $"Requested mime type is not registered: {mimeType}" );
        }
